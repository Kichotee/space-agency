...
<template>
    ...
    <div  class="relative text-babyBlue">
      ...
      <nav class="flex absolute  justify-between px-6 font-belle text-lg   w-screen lg:px-12
        ">
        <img src="./assets/assets/shared/logo.svg" class="mt-6 items-center w-10" alt="">
        <span class=" hidden lg:block h-1 color-whiteFade w-[40%] absolute bottom-10% left-8"></span>
        <div class="links hidden text-[14px] leading-[17px] tracking-[2.4px] absolute top-0 right-0 w-[60%] h-[96px] items-center 
        justify-start pl-6 lg:pl-[123px] h-50 md:flex gap-16  md:bg-whiteFade backdrop-blur-4xl font-barlow ;
]">
        ...
        <img class="md:hidden mt-6  self-center" src="./assets/assets/shared/icon-hamburger.svg" alt="">
      </nav>
    </div>
