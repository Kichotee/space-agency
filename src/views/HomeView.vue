...
<template>
<main @click='activeMenu=false'   class="max-w-[100vw] main landscape:overflow-scroll landscape:pt-48  overflow-hidden bg-[url('../assets/assets/home/background-home-mobile.jpg')] 
