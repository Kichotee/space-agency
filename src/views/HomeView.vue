...
<template>
<main @click='activeMenu=false' landscape:overflow-scroll   class="max-w-[100vw] main  overflow-hidden bg-[url('../assets/assets/home/background-home-mobile.jpg')   h-screen] 
